...
class Image {
    ...
    public:
        ...
        std::pair<Image, uint64_t> MahalanobisDistanceGPU (const std::vector<uint64_t> &data, uint64_t nc) const;
        std::pair<Image, uint64_t> MahalanobisDistanceCPU (const std::vector<uint64_t> &data, uint64_t nc) const;
